...
rem
rem $Id: service.bat,v 1.1 2004/04/18 18:16:10 obivatelj Exp $
rem ---------------------------------------------------------------------------
...
"%EXECUTABLE%" //US//%SERVICE_NAME% --JavaOptions -Dcatalina.home="\"%CATALINA_HOME%\""#-Djava.endorsed.dirs="\"%CATALINA_HOME%\common\endorsed\""#-Xrs#-Dorg.apache.tapestry.disable-caching="\"true\"" --StdOutputFile "%CATALINA_HOME%\logs\stdout.log" --StdErrorFile "%CATALINA_HOME%\logs\stderr.log" --WorkingPath "%CATALINA_HOME%\bin"
